...
export function LandingPage() {
  ...
  return <main className="public-home" data-locale={locale}>
    ...
    <section className="public-section organ-insight" aria-labelledby="organ-insight-title">
      ...
      <div className="organ-image-grid"><figure><img className="home-brain-dark" src="/media/home-brain-original-dark.webp?v=20260822" alt={t("Brain medical illustration", "رسم طبي للدماغ")} /><img className="home-brain-light" src="/media/home-brain-original-light.webp?v=20260822" alt="" aria-hidden="true" /><figcaption>{t("Neuroscience & cognition", "علوم الأعصاب والإدراك")}</figcaption></figure><figure><img src="/media/home-heart-processed.webp" alt={t("Heart and electrocardiogram medical illustration", "رسم طبي للقلب وتخطيط القلب")} /><figcaption>{t("Cardiovascular reasoning", "التفكير القلبي الوعائي")}</figcaption></figure></div>
    </section>
