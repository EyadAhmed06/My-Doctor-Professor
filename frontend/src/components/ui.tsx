...
export function Field({label,icon:Icon,placeholder,type="text",select=false,name,value,onChange,required=false,autoComplete,minLength,min,max,step}:{
  ...
  minLength?:number; min?:number; max?:number; step?:number;
}) {
  ...
  return <label className="field">
    ...
    <span className="input-shell">
      ...
      <input name={name} value={value} onChange={onChange} required={required} autoComplete={autoComplete} minLength={minLength} min={min} max={max} step={step}
