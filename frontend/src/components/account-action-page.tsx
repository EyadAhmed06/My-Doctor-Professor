...
export function VerifyEmailPage(){
  ...
  return <ActionLayout variant="verify" eyebrow="EMAIL VERIFICATION" title={verified?"You are verified.":"One final step."} description={verified?"Your account is active and ready for your learning journey.":"Verify your email to protect your account and activate every feature."}>
