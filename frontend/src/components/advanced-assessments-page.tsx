    ...
    try {
      const created = await request<Test>("/tests", {
        ...
        body: {
          ...
          available_until: draft.available_until || undefined,
        },
      });
      localStorage.removeItem(draftKey);
