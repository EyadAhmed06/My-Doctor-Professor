...
import { FiActivity, FiBell, FiChevronDown, FiMenu, FiSearch, FiX } from "react-icons/fi";
...
export function ProductShell({ children, search = "Search cases, topics, or concepts" }: { children: React.ReactNode; search?: string }) {
  ...
  return <div className="product-app">
    <header className="pp-topbar">
      <Link className="pp-brand" href="/dashboard"><span><FiActivity /></span><strong>The Doctor &amp; My Professor</strong></Link>
