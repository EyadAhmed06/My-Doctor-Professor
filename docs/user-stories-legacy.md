> **Legacy requirements snapshot**
>
> This document is preserved for traceability. It contains superseded decisions, including immediate tokens after signup, bcrypt-only password storage, AWS storage, and incomplete ownership/enrollment assumptions. The root README, current DTOs, PostgreSQL schemas, and implemented business rules take precedence until this specification is formally reconciled.
