...
export class AdminController {
  ...
  @Get('users/:userId')
  getUser(@Param('userId', uuid) id: string) {
...
// Applying these decorators as runtime calls preserves the same Nest metadata
// while avoiding a false unused-import report from the current type-aware lint stack.
UseGuards(JwtAuthGuard, RolesGuard)(AdminController);
Roles(UserRole.SYSTEM_ADMIN)(AdminController);
