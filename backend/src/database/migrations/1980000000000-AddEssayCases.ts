...
export class AddEssayCases1980000000000 implements MigrationInterface {
  name = 'AddEssayCases1980000000000';
  ...
  `); }
  async down(q: QueryRunner): Promise<void> { await q.query(`DROP TABLE IF EXISTS essay_case_answers; DROP TABLE IF EXISTS essay_case_attempts; DROP TABLE IF EXISTS essay_case_questions; DROP TABLE IF EXISTS essay_cases; DROP TYPE IF EXISTS essay_case_attempt_status;`); }
}
