...
export class ReconcileDatabaseContract1830000000000 implements MigrationInterface {
  name = 'ReconcileDatabaseContract1830000000000';
  ...
  public async down(): Promise<void> {
    // Contract reconciliation is intentionally forward-only. Reintroducing
    // destructive CASCADE behavior or nullable state is not a safe rollback.
  }
}
