...
export class NotebookNote {
  ...
  @Column({ type: 'varchar', length: 30, name: 'note_type' })
  noteType: string;
  ...
  @Column({ type: 'timestamp', name: 'review_at', nullable: true })
  reviewAt: Date | null;

  @Column('uuid', { name: 'linked_question_id', nullable: true })
  linkedQuestionId: string | null;

  @Column('uuid', { name: 'linked_lecture_id', nullable: true })
  linkedLectureId: string | null;
  ...
  @ManyToOne(() => NotebookCollection, (collection) => collection.notes, {
    onDelete: 'SET NULL',
    nullable: true,
  })
  ...
  @ManyToOne(() => Lecture, { onDelete: 'SET NULL', nullable: true })
  @JoinColumn({ name: 'linked_lecture_id' })
  linkedLecture: Lecture | null;

  @ManyToMany(() => NotebookTag, (tag) => tag.notes, {
    onDelete: 'CASCADE',
  })
  @JoinTable({
  ...
  @OneToMany(() => NotebookAttachment, (attachment) => attachment.note)
